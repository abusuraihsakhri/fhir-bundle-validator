"""
Command Line Interface for Fhir Bundle Validator.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="fhir-bundle-validator", description="Fhir Bundle Validator")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Fhir Bundle Validator Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Fhir Bundle Validator API server on http://{args.host}:{args.port}")
